...
describe("UserSignupPage", () => {
  ...
  describe("Interactions", () => {
    ...
    it("sets repeat the password value into state", () => {
      const { queryByPlaceholderText } = render(<UserSignupPage />);
    ...
    it(
      "calls postSignup when the fields are valid and the actions are" +
        "provided in props",
      () => {
        const actions = {
          // Resolve promise with an empty JSON object.
    ...
    it(
      "does not throw exception when clicking the button when actions" +
        "not provided in props",
      () => {
        setupForSubmit();
